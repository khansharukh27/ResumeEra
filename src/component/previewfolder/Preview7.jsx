...
const Preview7 = () => {
    ...
    return (
        <div className='preview-main7 '>
            <div className="resume-preview7" style={{ color:fontColor,backgroundColor: bgColor, fontFamily: fontStyle }} id="Alisha_mirza">
                ...
                <div className='d-flex justify-content-between contact-div7'>
                    <div className='text-end'>
                        ...
                        <div className=" education-div7">
                            <h5 style={{ color: headingColor }} className='heading7' >EDUCATION</h5>
                            <hr />
                        ...
                        <div className=' skills-div7'>
                            <h5 style={{ color: headingColor }} className='heading7'>SKILLS</h5>
                            <hr />
                        ...
                        <div className='hobbies-div7'>
                                <h5 style={{ color: headingColor }} className='heading7'>HOBBIES</h5>
                            <hr />
                    ...
                    <div className='job-experience7'>
                        <h5 style={{ color: headingColor }} className='heading7'> JOB EXPERIENCE</h5>
                        <hr />
                        ...
                        <div className="language7">
                            <h5 style={{ color: headingColor }} className='heading7'>LANGUAGE</h5>
                            <hr />
                        ...
                        <div>
                            <h5 style={{ color: headingColor }} className='heading7'>ABOUT ME</h5>
                            <hr />
