...
const Preview8 = () => {
    ...
    return (
        <div className="preview-main8">
            <div className="resume-preview8 " style={{ backgroundColor: bgColor, fontFamily: fontStyle }} id="Alisha_mirza">
                ...
                <div className='.main2-8'>
                    ...
                    <div>
                        ...
                        <div><h5 style={{ backgroundColor: 'black', color: 'white', padding: '3px' }}>LANGUAGE</h5>
