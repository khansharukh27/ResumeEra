...
const Preview10 = () => {
    ...
    return (
        <div className='d-sm-flex resume-10'>
            <div className="resume-preview10 " style={{ color:fontColor,backgroundColor: bgColor, fontFamily: fontStyle }} id="Alisha_mirza">
                <div className='main10' style={{ backgroundColor: 'grey' }}>
                    <div style={{ backgroundColor: 'black', color: 'white', }} className='main1-div10'>
                        ...
                        <div className=' jobtite10' style={{}} >
                            ...
                            <h5 style={{color:headingColor}} className=" education10"  >EDUCATION</h5>
                    ...
                    <div className='' style={{ backgroundColor: 'grey' }}>
                        <h5 style={{color:headingColor}} className='heading' >SKILLS</h5>
                        ...
                        <h5 style={{color:headingColor}} className='mt-5'> CONTACT</h5>
                        <div className=' mb-4' style={{ width: '50px', height: '4px', backgroundColor: 'yellow' }}></div>
                        <div>
                ...
                <div className='main2-10'>
                    ...
                    <h5 style={{color:headingColor}} className=''> JOB EXPERIENCE</h5>
                    <div className=' mb-4' style={{ width: '50px', height: '4px', backgroundColor: 'yellow' }}></div>
                    ...
                    <div><h5 style={{color:headingColor}} className=''>HOBBIES</h5></div>
                    <div className=' mb-4' style={{ width: '50px', height: '4px', backgroundColor: 'yellow' }}></div>
                    ...
                    <h5 style={{color:headingColor}} className='' >ABOUT ME</h5>
                    <div className=' mb-4' style={{ width: '50px', height: '4px', backgroundColor: 'yellow' }}></div>
                    <div className=' row'>
                    ...
                    <div><h5 style={{color:headingColor}} >LANGUAGE</h5></div>
                    <div className=' mb-4' style={{ width: '50px', height: '4px', backgroundColor: 'yellow' }}></div>
