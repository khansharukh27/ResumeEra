            ...
            <div className='me-4 resume-13' style={{ color:fontColor,backgroundColor: bgColor, fontFamily: fontStyle, width: '100%' }} id='Alisha_mirza'>
                ...
                <div className='d-flex justify-content-between resume-main-2 '>
                    <div className='ms-3 resume-main-2-1'>
                        <h5 style={{color:headingColor}} className=' '><i class="bi bi-person-lines-fill me-2"></i> CONTACT</h5>
                        ...
                        <h5 style={{color:headingColor}} className="mt-5"  > <i class="bi bi-journal-code me-2"></i>EDUCATION</h5>
                        <div className='mb-4' style={lineStyle}></div>
                        ...
                        <h5 style={{color:headingColor}} className='mt-5'><i class="bi bi-mortarboard-fill me-2" style={{ color: '#082f36cc' }}></i>SKILLS</h5>
                        <div className='mb-4' style={lineStyle}></div>
                    ...
                    <div className='me-3 resume-main-2-2'>
                        <div>
                        <h5 style={{color:headingColor}}><i class="bi bi-people-fill me-2"></i><b style={{ lineHeight: '.5' }}>ABOUT ME</b></h5>
                            <div className='mb-4' style={lineStyle}></div>
