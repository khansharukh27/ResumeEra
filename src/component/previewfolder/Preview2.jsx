            ...
            <div className=" main" id="Alisha_mirza" style={{ backgroundColor: bgColor, fontFamily: fontStyle }}>
                <div className="main1">
                    ...
                    <div className="maininner3">
                        <h1><i className="bi bi-person-lines-fill" />Contact</h1>
                ...
                <div className="main2">
                    <div className="about">
                        <h1><i className="bi bi-file-person-fill me-2"></i>About</h1>
                        <p>{personalInfo.object}</p>
                        <div className="jobExperience">
                            <h1><i className="bi bi-briefcase-fill me-2"></i>Job Experience</h1>
                        ...
                        <div className="skill-section">
                            <h1><i className="bi bi-mortarboard me-2"></i>Skills</h1>
