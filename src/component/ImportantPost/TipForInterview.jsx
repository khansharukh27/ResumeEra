...
const TipForInterview = () => {
    const ArticleUrl = "https://resumeera.xyz/Tip_for_Interview"
    const ArticleTitle = 'Tip for Interview:ResumeEra'
    useEffect(() =>{
        window.scrollTo(0,0)
    },[])
    return (
        <div className="aboutResumeEra">
            <Helmet>
                ...
                <meta name="description" content="Preparing for an interview requires a blend of research, practice, 
                    and mental preparation. In this comprehensive 2200-word guide, we'll cover essential tips to help you stand out in your interview, 
                    regardless of the role or industry.</p>
           " />
                <meta name="keywords" content="Tip for Interview,free resume builder, free resume download, free resume templates, best resume site, online resume builder" />
...
export default TipForInterview