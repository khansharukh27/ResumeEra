...
export default function AtsFormattingMistake(){
  ...
  return (
    ...
    <div className='aboutResumeEra'>
      <Helmet>
        <title>11 ATS Formatting Mistakes That Can Cost You a Job</title>
        <meta
          name="description"
     ...
     <DateAndAuthor/>
      ...
      <p>Applicant Tracking Systems (ATS) are used by many employers to filter and rank resumes. Avoid these common ATS formatting mistakes to ensure your resume gets through the ATS and into the hands of hiring managers.</p>
      <div><GoogleAd/></div>
      ...
      <p>ATS systems often can't read images or graphics, so avoid including them in your resume. Stick to text-based content to ensure all your information is captured.</p>
      ...
      <p>Keywords play a crucial role in ATS optimization. These systems scan resumes for specific terms that match the job description. Failing to include relevant keywords can result in your resume being ranked lower or even rejected. Carefully review the job posting and incorporate applicable keywords naturally throughout your resume to improve your chances of passing the ATS screening.</p>
      <div><GoogleAd/></div>
      ...
      <p>Creating an ATS-optimized resume is essential in today's competitive job market. By avoiding common formatting mistakes and following best practices, you can increase your chances of getting your resume noticed by employers. Remember to keep your resume simple, use standard fonts, and include relevant keywords. Test your resume with an ATS-friendly tool to ensure it will be read correctly by the system. With these tips, you'll be well on your way to creating an ATS-optimized resume that stands out to hiring managers.</p>
    </div>
    <section>
