...
import Border_Fashion_married from '../../../image/shadi biodata/Free_Heart_Border_Clipart.png';

export default function Preview401() {
  const result = useSelector((state) => state.reducer.shadiData[0]);
  const [data, setData] = useState(null);

  // Check if the result from Redux is available and fallback to localStorage
  

  // Styles and settings for font, background color, margins, etc.
      ...
      >
        ...
        <div className='personal-info401 d-flex justify-content-between'>
          ...
          <div style={{ width: '50%', display: 'flex', justifyContent: 'end', maxHeight: '400px' }}>
            <img
              className='image401'
              src={data.image || 'fallback_image.png'} // Fallback image if none exists
              alt="man preview"
