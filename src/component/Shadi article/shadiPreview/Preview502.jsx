...
import '../shadiPreview/preview502.css'
import GoogleAd from '../../adFolder/GoogleAd';
import Border_Fashion_married from '../../../image/shadi biodata/Muslim merrieage biodata/DarkBlueStarShadiCard.jpg'
    ...
    return (
        <div >
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview401 inner-content preview502"
                    style={{
                        padding: `${padding}px`,
                        margin: `${margin}px`,
                    ...
                    >
                        <div className=''>
                            <div className=" d-flex justify-content-between personal-info502" style={{height:'fit-content'}} >
                                <div style={{lineHeight:sectionSpacing,paddingBottom:'0px'}}>
                                ...
                                <div style={{lineHeight:sectionSpacing, height:'fit-content',width: '50%', display: 'flex', justifyContent: 'end' }}>
                                    <img
                                        className="image401"
                                        src={data.image}
                                        alt="man preview"
                            ...
                            <div style={{lineHeight:sectionSpacing,marginTop:'-40px'}}>
                                <h3 style={{ color: headingColor, fontSize: `${headingSize}px`,lineHeight:sectionSpacing }}>
                                    Family Details
                                </h3>
                                <div>
                                    <p style={{ fontSize: `${fontSize}px`, color: fontColor, fontFamily: fontStyle,lineHeight:lineSpacing }}>
