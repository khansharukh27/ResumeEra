...
import '../shadiPreview/preview503.css'
...
export default function Preview504() {
    ...
    const [fontSize, setFontSize] = useState(20); // Font size for paragraphs
    const [headingSize, setHeadingSize] = useState(20); // Font size for headings
    const [margin, setMargin] = useState(10); // Margin for resume wrapper
    const [padding, setPadding] = useState(400); // Padding for sections
        ...
        <div >
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview503 "
                    ...
                    >
                        <div className=''>
                            <div className="personal-info503 d-flex" style={{marginTop:'250px'}} >
                                <div>
                                ...
                                <div style={{ width: '50%', display: 'flex', justifyContent: 'start', maxHeight: '400px' }}>
                                    <img
                                        className="image401"
                                        src={data.image}
                                        alt="man preview"
