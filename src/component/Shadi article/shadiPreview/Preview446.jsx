...
import Border_Fashion_married from '../../../image/shadi biodata/white-japanese-crane-with-rosemallows-pattern-frame-template_53876-113726.jpg'

export default function Preview446() {
        ...
        <div >
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview401 inner-content"
                    ...
                    >
                        <div className=''>
                            <div className="personal-info401 d-flex justify-content-between" style={{lineHeight:sectionSpacing}}>
                                <div>
