...
import Border_Fashion_married from '../../../image/shadi biodata/realistic-photo-frame-element-isolated.jpg'

export default function Preview437() {
        ...
        <div >
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview401 inner-content"
                    ...
                    >
                        <div className=''>
                            <div className="personal-info401 d-flex justify-content-between" style={{marginTop: '120px',lineHeight:sectionSpacing}}>
                                <div>
