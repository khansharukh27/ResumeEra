...
import Border_Fashion_married from '../../../image/shadi biodata/flat-lay-blue-floral-frame-yellow-background_23-2148274594.jpg'

export default function Preview423() {
        ...
        <div >
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview401 inner-content"
                    ...
                    >
                        <div className=''>
                            <div className="personal-info401 d-flex justify-content-between" style={{lineHeight:sectionSpacing,marginTop:'200px'}}>
                                <div>
