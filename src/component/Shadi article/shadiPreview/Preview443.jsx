...
import Border_Fashion_married from '../../../image/shadi biodata/top-view-white-floral-frame-pink-background_23-2148274597.jpg'

export default function Preview443() {
        ...
        <div >
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview401 inner-content"
                    ...
                    >
                        <div className=''>
                            <div className="personal-info401 d-flex justify-content-between" style={{marginTop:'150px',lineHeight:sectionSpacing}}>
                                <div >
