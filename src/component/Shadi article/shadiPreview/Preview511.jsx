...
import Border_Fashion_married from '../../../image/shadi biodata/Muslim merrieage biodata/LightBlueFlowerShadiCard.jpg'
                ...
                <div class=" preview401 inner-content"
                    ...
                    >
                        <div className='' style={{ marginTop: '-150px' }}>
                            <div class="container503" style={{ height: '150px' }}>
                                <p class="arabic-text" style={{ color: '#c48f29', }}>الله</p>
                                <p class="bismillah" style={{ color: '#c48f29' }}>بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ</p>
                            </div>
                            <div className="personal-info401 d-flex justify-content-between">
                                <div style={{lineHeight:sectionSpacing}}>
                                    ...
                                    <p style={{ fontSize: `${fontSize}px`, color: fontColor, fontFamily: fontStyle ,lineHeight:lineSpacing ,lineHeight:lineSpacing }}>
