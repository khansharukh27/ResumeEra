...
import Border_Fashion_married from '../../../image/shadi biodata/Muslim merrieage biodata/goldenColumnWithblue.jpg'
...
export default function Preview504() {
  ...
  <p class="arabic-text" style={{  fontSize: `${fontSize}px`, color: '#c48f29', fontFamily: fontStyle,lineHeight:lineSpacing }}>الله</p>
  <p class="bismillah" style={{  fontSize: `${fontSize}px`, color: '#c48f29', fontFamily: fontStyle,lineHeight:lineSpacing }}>بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ</p>
</div>
