...
import Border_Fashion_married from '../../../image/shadi biodata/black-frame-hanging-vintage-style-wallpaper_1048-1395.jpg'

export default function Preview411() {
        ...
        <div >
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview401 inner-content"
                    ...
                    >
                        <div className=''>
                            <div className="personal-info401 d-flex justify-content-between" style={{marginTop:'100px'}}>
                                <div>
