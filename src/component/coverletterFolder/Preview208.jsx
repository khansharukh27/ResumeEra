...
export default function Preview208() {
...
<Toolbar toggleStyle={toggleStyle} changeAlignment={changeAlignment} toggleList={toggleList}  />
            ...
            spellCheck={true}
                ...
                <div className='header208 d-flex justify-content-between'>
                    <div className="left208" style={{width:'50%',textAlign:'end',backgroundColor:'#bd9456',height:'fit-content',paddingLeft: '10px',paddingRight:'10px',padding:'5px'}}>
                        <h3 className='text-end' style={dynamicStyle.heading}>{result.fullname}</h3>
                        <h3 className='text-end' style={dynamicStyle}>{result.jobposition}</h3>
                    </div>

                    <div className="right208 " style={{backgroundColor:''}}>
                        <p className='text-end' style={dynamicStyle}>{result.email} <span className="icon" style={{backgroundColor:'#bd9456'}} >✉️</span></p>
                        <p className='text-end' style={dynamicStyle}>{result.mobileNumber} <span className="icon" style={{backgroundColor:'#bd9456'}} >📞</span></p>
                        <p className='text-end' style={dynamicStyle}>{result.city}, {result.state || "CA"} <span className="icon" style={{backgroundColor:'#bd9456'}}>📍</span></p>
                        <p className='text-end' style={dynamicStyle}>{result.linkedin} <span className="icon" style={{backgroundColor:'#bd9456'}} >🔗</span></p>
                    </div>
                </div>
