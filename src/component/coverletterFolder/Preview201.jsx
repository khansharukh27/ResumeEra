...
const Preview201 = () => {
    ...
    return (
        <div className="preview-container201">
            ...
            <div className="contact-201" style={{ color: headingColor }}>
                <p style={{ color: headingColor }}>{result.email}</p>
                <p style={{ color: headingColor }}>{result.mobileNumber}</p>
                <p style={{ color: headingColor }}>{result.city} {result.state}</p>
               <p style={{ color: headingColor }}>{result.linkedin}</p>
            </div>
            <div className="company-detail-201">
                To <br />
                <p style={{ color: headingColor }}>{result.hiringManager}</p>
                <p style={{ color: headingColor }}>{result.companyName}</p>
                <p style={{ color: headingColor }}>{result.companyWebsite}</p>
                <p style={{ color: headingColor }}>{result.companyLocation}</p>
            </div>
            <div className="your-object-201">
                <p style={{ color: headingColor }}>DEAR {result.hiringManager}</p>
                <p style={{ color: headingColor }}>{result.object}</p>
            </div>
            <div className="sincerely-201"><p style={{ color: headingColor }}>SINCERELY</p>
            <p style={{ color: headingColor }}>{result.fullname}</p>
            </div>
            </div>
